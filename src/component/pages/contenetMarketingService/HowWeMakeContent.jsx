...
export const HowWeMakeContent = () => {
  ...
  const desc =
    "Good content should feel effortless to read and meaningful to the person on the other side of the screen. That’s why we focus on creating content that speaks to people and delivers results for your business.";
