...
export const WhyTrust = () => {
  ...
  const data = [
    {
      ...
      desc: "Our consultants aren’t just certified — they’re seasoned professionals who bring deep experience across industries such as pharmaceuticals, BFSI, retail, professional services, and manufacturing. This enables us to offer tailored solutions that align with sector-specific regulations, workflows, and KPIs.",
  ...
  return (
    <CommonCard
      ...
      description="At the core of our consulting model is a commitment to delivering value that drives lasting impact across industries. Here’s why enterprises continue to choose and recommend us:"
      footer=""
    />
  );
};
