...
export const RealTimeThreat = () => {
  ...
  const data = [
    {
      ...
      description:
        "We Actively Search For Hidden Vulnerabilities And Potential Threats Before They Have A Chance To Cause Harm. Our Team Simulates Real-World Attack Scenarios To Identify Weaknesses That Standard Monitoring Might Miss.",
      bgcolor: "#6d3119",
    ...
    },
    {
      ...
      description:
        "Advanced Analytics Track Unusual Behavior, Patterns, And Anomalies Across Your Systems. By Combining AI-Driven Insights With Expert Analysis, We Spot Risks That Often Go Unnoticed.",
      bgcolor: "#474574",
    ...
    },
    {
      ...
      description:
        "If A Threat Occurs, Our Expert Team Jumps In Immediately To Contain And Neutralize It. We Follow A Structured, Clean Process To Minimize Disruption And Protect Your Data.",
      bgcolor: "#bbb7a2ff",
  ...
  const footer =
    "These services are designed to work together, providing a complete defense mechanism that proactively protects your assets and rapidly responds to any security incidents.";
