...
const cardData = [
  ...
  },
  {
    ...
    description:
      'From strategy and ads to design, content, and code — it all happens here, together. No handoffs. No finger-pointing. One accountable outcome',
    icon: '/icons/team.svg',
    bgColor: '#E7E4C2',
  },
  {
  ...
  },
  {
    ...
    description:
      'From fast-growing startups to complex enterprises — we know what works, what doesn’t, and how to skip the trial-and-error phase.',
  ...
  },
  {
    ...
    description:
      'You’ll never have to chase us for updates. We’re hands-on, easy to talk to, and focused on one thing: making your brand stronger without making your day harder.',
