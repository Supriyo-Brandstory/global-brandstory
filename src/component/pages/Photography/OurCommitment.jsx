...
export const OurCommitment = () => {
  const title = "Our Commitment to Quality<br/>& Client Success"
  const desc = "At BrandStory, we ensure every project achieves the highest level of professionalism. Our professional photography services are consistently delivered on time, on budget, and with careful attention to detail."
