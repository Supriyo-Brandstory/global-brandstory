...
export const MeasurableResults = () =>{
   ...
   text1="Our marketing automation agency approach fixes this. We connect email, CRM, social, and analytics into one system. Once it’s set up, your campaigns run automatically.<br />Automation helps you:"
