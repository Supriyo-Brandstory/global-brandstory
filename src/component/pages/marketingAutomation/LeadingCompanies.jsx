...
export const LeadingCompanies = () => {
  ...
  return (
    <CommonCard
      seoData={seoData}
      heding="Why Leading Companies Turn to BrandStory for Automation"
      description="Businesses Work With Us Because We Are Marketing Automation Experts"
      footer="With BrandStory, your automation helps your business grow, builds trust with your audience, and turns leads into happy, repeat customers."
    />
  );
};
