...
export const CoreCapabilities = ()=>{
  const boxHeight = "330px";
    const seoData = [
      {
        ...
        icon: "/images/Webdev/ws-1.png", // Icon maintained as requested
      ...
      },
      {
        ...
        icon:"/images/Webdev/ws-2.png", // Icon maintained as requested
      ...
      },
      {
        ...
        icon:"/images/Webdev/ws-3.png", // Icon maintained as requested
      ...
      },
      {
        ...
        icon:"/images/Webdev/ws-4.png", // Icon maintained as requested
        background:"url('/images/ppc/bg-1.png')",
        height: boxHeight
      },
      {
        ...
        icon:"/images/Webdev/ws-5.png", // Placeholder Icon maintained
        background:"url('/images/ppc/bg-2.png')", // Placeholder background maintained
        height: boxHeight
      },
      {
        ...
        icon:"/images/Webdev/ws-3.png", // Placeholder Icon maintained
        background:"url('/images/ppc/bg-3.png')", // Placeholder background maintained
        height: boxHeight
      }
    ];
    ...
    return <CommonCard 
        ...
        description="" // The description field above the cards is empty in the screenshot's structure.
