...
export const Pricing = () => {
  ...
  const description =
    "Our local SEO packages are designed to meet you where you are, whether you’re just starting out or scaling across cities. Each plan includes the essentials with room to grow.<br/><br/><b class='highlited-text'>Here’s how we break it down:</b>";
  const footer = "";
  const data = [
    {
      title: "Starter Plan",
