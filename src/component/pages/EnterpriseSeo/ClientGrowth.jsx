...
export const ClientGrowth = () => {
  ...
  const description =
    "Our enterprise SEO strategies deliver measurable outcomes across industries from high-growth startups to established global enterprises. Here's a snapshot of how we’ve helped brands scale search visibility, traffic, and revenue at pace.";
  const footer = "";
  const data = [
    {
      title: "SaaS Unicorn",
