...
export const AudienceTargeting = () => {
  const data = [
    ...
    },
    {
      ...
      description:
        "Reach Consumers Who Are Actively Looking For Goods Or Services Similar To Yours.",
    ...
    },
    {
      ...
      description:
        "Re–Engage Previous Visitors With Personalized Messages That Entice Them To Come Back And Convert.",
  ...
  return (
    <CommonThreeCardBlur
      ...
      footer="By re-engaging past visitors and focusing on high-intent audiences, we boost conversions and keep your brand top-of-mind, turning interest into real business results."
      data={data}
    />
  );
};
