...
export const ReputationCoverage = () => {
    const data = {
        ...
        rows: [{
            ...
            text: [
                "We Create:",
                "<ul><li><b>Search Engines (Google, Bing):</b> We make sure that when people search for your brand, they see reliable and trustworthy information first.</li></ul>",
                "<ul><li><b>Review Websites (Google Reviews, Yelp, Glassdoor):</b> We keep an eye on reviews, respond to them, and manage them to build trust with customers, partners, and employees.</li></ul>",
                "<ul><li><b>Social Media (LinkedIn, Facebook, Instagram, Twitter):</b> We maintain a professional and active presence to protect your reputation on social media.</li></ul>",
                "<ul><li><b>Forums & News Sites:</b> We watch for mentions of your brand and join conversations when needed to protect your image.</li></ul>",
