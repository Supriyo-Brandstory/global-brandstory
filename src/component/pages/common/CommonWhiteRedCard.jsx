...
export const CommonWhiteRedCard = ({ title, cards, footer }) => {
  ...
  return (
    <>
        ...
        <div className={styles.cardsContainer}>
          ...
          <div className={styles.cardsWrapper}>
            <Swiper
              ...
              grabCursor={true}
              autoHeight={false}
              onSwiper={setSwiperInstance}  // ✅ capture instance
              pagination={{
                clickable: true,
                dynamicBullets: true
              }}
      ...
      {footer && (
        <div
          className="mx-auto max-w-[1000px] pb-10 text-center"
        ...
        <div className={styles.navigation}>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 74 74" width="74" height="74">
              <style>{`.s0 { fill: none; stroke: #e73d26 } .s1 { fill: #e73d26 }`}</style>
              <g>
                <path fillRule="evenodd" className="s0" d="m37 62.5c-16.31 0-29.5-13.19-29.5-29.5 0-16.31 13.19-29.5 29.5-29.5 16.31 0 29.5 13.19 29.5 29.5 0 16.31-13.19 29.5-29.5 29.5z" />
              </g>
              <path className="s1" d="m39.22 40.25q0.19-0.21 0.28-0.48 0.09-0.27 0.07-0.55-0.02-0.28-0.14-0.54-0.13-0.25-0.34-0.44l-5.9-5.16 5.16-5.9c0.25-0.28 0.37-0.65 0.35-1.03-0.03-0.38-0.2-0.73-0.48-0.98-0.29-0.25-0.66-0.37-1.04-0.35-0.37 0.03-0.73 0.2-0.97 0.49l-6.11 6.98q-0.19 0.21-0.28 0.48-0.09 0.27-0.07 0.55 0.02 0.28 0.14 0.54 0.13 0.25 0.34 0.44l6.98 6.1c0.58 0.51 1.49 0.45 2.01-0.15z" />
            </svg>
          </button>
          <button
          ...
          >
            <svg width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="37" cy="33" r="29.5" stroke="#E73D26" />
