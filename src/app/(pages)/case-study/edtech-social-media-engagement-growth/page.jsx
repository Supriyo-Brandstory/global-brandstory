  ...
  items={[
    {
      ...
      description:
        "<ul><li>Developed educational posts focused on VLSI learning concepts</li><li>Created career-driven content highlighting industry opportunities</li><li>Used structured content formats such as carousels and informative posts</li><li>Maintained a consistent posting cadence</li></ul>",
    },
    {
      icon: "users",
      title: "Creative Approach",
      description:
        "<ul><li>Visual-first content for Instagram engagement</li><li>Informational and authority-driven content for LinkedIn</li><li>Clean, structured layouts for better readability</li><li>Messaging aligned with career outcomes</li></ul>",
    },
    {
      icon: "users",
      title: "Optimization Approach",
      description:
        "<ul><li>Continuous monitoring of engagement metrics</li><li>Refinement of content topics based on performance</li><li>Improvement of format and clarity for better interaction</li><li>Iterative updates based on audience response</li></ul>",
    },
  ]}
/>
  ...
  stats={[
    {
      ...
      oldValue: "2.99%",
      newValue: "4.61%",
      badges: ["+54% growth", "improved click-through performance"],
    },
    {
