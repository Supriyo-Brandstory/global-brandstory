...
const page = () =>{
    return(
        <>
            <Banner />
            <CommonDivider /><HowSoftwareArchitecture />
            <CommonDivider /><AdvancedSoftwareSolutions />
            <CommonDivider /><OurMethod />
            <CommonDivider /><TheDiffrence />
            <CommonDivider /><ActionableStrategies />
            <CommonDivider /><ExpertBehind />
