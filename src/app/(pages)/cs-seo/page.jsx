...
const challengeResolutionCards = [
  {
    number: "1",
    title2: "Outcome",
    sections: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        label: "Resolution",
        value: "Strengthened On-Page Optimization And Technical SEO Foundation",
      },
  ...
  },
  {
    ...
    title2: "Outcome",
    sections: [
      { label: "Challenge", value: "Need To Attract Higher-Value Traffic" },
      {
        label: "Resolution",
...
const page = () => {
  return (
    <div>
      ...
      />
      <CommonDivider />
      <CsProcess title="Our Process" steps={processSteps} />

      <CsStepCards
        title="Challenges and Resolutions"
        cards={challengeResolutionCards}
      />
      <CommonDivider />
