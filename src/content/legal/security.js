const security = {
  ...
  metaTitle: "Security Statement | BrandStory Global",
  metaDescription:
    "How BrandStory Global approaches website and enquiry security, and how to report concerns.",
  intro:
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Send a concise description and affected URL to <a href=\"mailto:[SECURITY_EMAIL]\">[SECURITY_EMAIL]</a>. Do not include exploit code, credentials, personal information or confidential client data in the first message. BrandStory does not authorise testing that disrupts services, accesses data, uses social engineering or violates law.",
      ],
    },
  ],
};
